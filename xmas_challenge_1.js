...
Christmas Challenge @wswieciekodu
     ...
     * For 10 units of distance, his sleigh uses 20 litres of magic fuel.
     * How much fuel does he need for the entire route? To count, prepare the corresponding code.
     * The calculated result writes on the screen.
     *
...
let paliwo = (dystans(miasto1.x, miasto1.y, miasto2.x, miasto2.y) + dystans(miasto2.x, miasto2.y, miasto3.x, miasto3.y)) * 20 /10;
